/**
 * `triage` — classify issues and pull requests, and manage their lifecycle.
 *
...
/**
 * @typedef {SharedInputs & { labels: string[], dryRun: boolean }} Inputs
 */
...
export async function run(_inputs, _context) {
  ...
  return Promise.reject(
    new Error(
      "triage is not implemented yet — the action reads and validates its inputs, and does nothing else.",
    ),
  );
}
