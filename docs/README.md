...
| [Development: Archkeep runtime integration](development/archkeep-integration-analysis.md) | Design record (issue #518) — runtime architecture evidence: the boundary, the recipe laws, the phased plan       |
...
| [Guide: architecture intelligence](guides/architecture-intelligence.md)                   | The release-triggered descriptive surfaces — health, debt, trajectory — and the history-dir law the actions hold |
